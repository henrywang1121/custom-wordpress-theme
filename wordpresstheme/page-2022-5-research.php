...
<div class="breadcrumb-search__container">
	<div class="breadcrumb-search">
		<div class="breadcrumb-search__content breadcrumb-search__content--research">
			<h1 class="breadcrumb-search__title">2022 MX-5 Miata</h1>
		</div>
		<!--<div class="breadcrumb-search__cta">
			<a class="button button--primary--black"
				href="/inventory/?inventory=new-cars&model=MX-5%20Miata">Explore MX-5 Miata Inventory</a>
		</div>-->
	</div>
</div>
...
<div class="research">
	<div class="research__hero">
		<picture>
			<source type="image/avif"
				srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-hero.avif' ); ?>">
			<source type="image/webp"
				srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-hero.jpg.webp' ); ?>">
			<img loading="eager"
				decoding="auto"
				src="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-hero.jpg' ); ?>"
				width="960"
				height="552"
				alt="">
		</picture>
		<div class="research__hero__headline">
			<span>The 2022 car MX-5 Miata</span>
			Engineered for the Heart
		</div>

		<div class="research__hero__ctas">
			<p class="disclaimer">car MX-5 Miata Grand Touring shown.</p>
			<!--<a class="button button--primary--white" href="/inventory/?inventory=new-cars&model=MX-5%20Miata">View Inventory</a>-->
			<?php
			...
			<!--<button class="button button--secondary--transparent ga-event"
				...
				data-ga-cat="2022 car MX-5 Miata"
				data-ga-action="Click"
				data-ga-label="Schedule Test Drive Button">Schedule Test Drive</button>-->
		</div>
	</div>
	<div class="research__trims">
		<h2><span>car MX-5 Miata Trims</span> Pick Your Style</h2>
		<div class="research__trims__carousel">
			<div class="research__trims__carousel__cell">
				<div class="research__trims__carousel__photo">
					<picture>
						<source type="image/avif"
							srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-trims-sport.avif' ); ?>">
						<source type="image/webp"
							srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-trims-sport.png.webp' ); ?>">
						<img loading="lazy"
							decoding="async"
							src="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-trims-sport.png' ); ?>"
							width="960"
							height="552"
							alt="">
					</picture>
				...
				<div class="research__trims__carousel__details">
					...
					<div class="research__trims__carousel__details__price">Starting at $27,650<sup>3</sup></div>
					<p class="disclaimer">Sold Out</p>
					<ul>
						<li>Apple CarPlay&trade; and Android Auto&trade; integration<sup>4</sup></li>
						<li>Smart City Brake Support<sup>5</sup></li>
						<li>LED headlights and taillights</li>
					</ul>
					<!--<a class="button button--primary--black" href="/inventory/?inventory=new-cars&model=MX-5%20Miata&trim=Sport">View Inventory</a>-->
				</div>
			</div>
			<div class="research__trims__carousel__cell">
				<div class="research__trims__carousel__photo">
					<picture>
						<source type="image/avif"
							srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-trims-club.avif' ); ?>">
						<source type="image/webp"
							srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-trims-club.png.webp' ); ?>">
						<img loading="lazy"
							decoding="async"
							src="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-trims-club.png' ); ?>"
							width="960"
							height="552"
							alt="">
					</picture>
				...
				<div class="research__trims__carousel__details">
					...
					<div class="research__trims__carousel__details__price">Starting at $31,150<sup>3</sup></div>
					<p class="disclaimer">Sold Out</p>
					<ul>
			...
			<div class="research__trims__carousel__cell">
				<div class="research__trims__carousel__photo">
					<picture>
						<source type="image/avif"
							srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-trims-grand-touring.avif' ); ?>">
						<source type="image/webp"
							srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-trims-grand-touring.png.webp' ); ?>">
						<img loading="lazy"
							decoding="async"
							src="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-trims-grand-touring.png' ); ?>"
							width="960"
							height="552"
							alt="">
					</picture>
				...
				<div class="research__trims__carousel__details">
					...
					<div class="research__trims__carousel__details__price">Starting at $32,650<sup>3</sup></div>
					<p class="disclaimer">Sold Out</p>
					<ul>
						<li>Adaptive Front-lighting System</li>
						<li>Heated leather-trimmed seats</li>
						<li>Wireless Apple CarPlay&trade;<sup>8</sup></li>
					</ul>
					<!--<a class="button button--primary--black" href="/inventory/?inventory=new-cars&model=MX-5%20Miata&trim=Grand%20Touring">View Inventory</a>-->
				</div>
			</div>
		</div>
		<div class="research__trims__carousel__nav">
			<div class="research__trims__carousel__nav__cell" data-target-trim="sport">
				...
				<h4 class="research__trims__carousel__nav__title">Sport</h4>
				<div class="research__trims__carousel__nav__price">Starting at $27,650<sup>3</sup></div>
				<p class="disclaimer">Sold Out</p>
			</div>
			<div class="research__trims__carousel__nav__cell" data-target-trim="club">
				...
				<div class="research__trims__carousel__nav__price">Starting at $31,150<sup>3</sup></div>
				<p class="disclaimer">Sold Out</p>
			</div>
			<div class="research__trims__carousel__nav__cell" data-target-trim="gt">
				...
				<div class="research__trims__carousel__nav__price">Starting at $32,650<sup>3</sup></div>
				<p class="disclaimer">Sold Out</p>
			</div>
		</div>
		<div class="disclaimers">
			...
			<p class="disclaimer"><sup>4</sup>Requires compatible phone, and standard text and data rates apply. Third-party interface providers are solely responsible for their product functionality, and third-party terms and privacy statements apply. Don&rsquo;t drive while distracted or while using a hand-held device. Android and Android Auto are trademarks of Google LLC. Apple CarPlay, iPhone and Siri are trademarks of Apple Inc.</p>
			<p class="disclaimer"><sup>5</sup>Smart City Brake Support operates under certain low-speed conditions between about 2 and 18 mph. It is not a substitute for safe and attentive driving and is only designed to reduce damage in the event of a collision. There are limitations to the operation and detection of the system. Please see your Owner&rsquo;s Manual for further details.</p>
			<p class="disclaimer"><sup>8</sup>Requires compatible iPhone and standard text and data rates apply. Apple is solely responsible for CarPlay functionality and its terms and privacy statements apply. Don&rsquo;t drive while distracted or while using a hand-held device. Apple CarPlay, iPhone and Siri are trademarks of Apple Inc.</p>
		</div>
	</div>
	...
	<div class="research__gallery">
		<div class="research__gallery__row">
			<div class="research__gallery__photo">
				<picture>
					<source type="image/avif"
						srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-gallery-1.avif' ); ?>">
					<source type="image/webp"
						srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-gallery-1.jpg.webp' ); ?>">
					<img loading="lazy"
						decoding="async"
						src="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-gallery-1.jpg' ); ?>"
						width="1800"
						height="1013"
						alt="">
				</picture>
			...
			<div class="research__gallery__photo">
				<picture>
				<source type="image/avif"
					srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-gallery-2.avif' ); ?>">
				<source type="image/webp"
					srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-gallery-2.jpg.webp' ); ?>">
				<img loading="lazy"
					decoding="async"
					src="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-gallery-2.jpg' ); ?>"
					width="1800"
					height="1013"
					alt="">
					</picture>
			...
			<div class="research__gallery__photo">
				<picture>
				<source type="image/avif"
					srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-gallery-3.avif' ); ?>">
				<source type="image/webp"
					srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-gallery-3.jpg.webp' ); ?>">
				<img loading="lazy"
					decoding="async"
					src="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-gallery-3.jpg' ); ?>"
					width="1800"
					height="1013"
					alt="">
					</picture>
		...
		<div class="research__gallery__row">
			<div class="research__gallery__photo">
				<picture>
				<source type="image/avif"
					srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-gallery-4.avif' ); ?>">
				<source type="image/webp"
					srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-gallery-4.jpg.webp' ); ?>">
				<img loading="lazy"
					decoding="async"
					src="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-gallery-4.jpg' ); ?>"
					width="1800"
					height="1013"
					alt="">
					</picture>
			...
			<div class="research__gallery__photo">
				<picture>
				<source type="image/avif"
					srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-gallery-5.avif' ); ?>">
				<source type="image/webp"
					srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-gallery-5.jpg.webp' ); ?>">
				<img loading="lazy"
					decoding="async"
					src="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-gallery-5.jpg' ); ?>"
					width="1800"
					height="1013"
					alt="">
					</picture>
			...
			<div class="research__gallery__photo">
				<picture>
				<source type="image/avif"
					srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-gallery-6.avif' ); ?>">
				<source type="image/webp"
					srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-gallery-6.jpg.webp' ); ?>">
				<img loading="lazy"
					decoding="async"
					src="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-gallery-6.jpg' ); ?>"
					width="1800"
					height="1013"
					alt="">
					</picture>
	...
	<div class="research__color-specials">
		<div class="research__color">
			...
			<ul class="research__color__area__tabs" id="researchColorAreaTabs" role="tablist">
				...
				<li role="presentation">
					<button class="tab-link" id="roof-tab" data-target="#roof" type="button" role="tab" aria-controls="roof" aria-selected="false">Roof</button>
				</li>
				<li role="presentation">
			...
			<div class="research__color__area__tabs-content" id="researchColorAreaTabsContent">
				<div class="tab-panel show" id="exterior" role="tabpanel" aria-labelledby="exterior-tab">
					...
					<ul class="research__color__exterior__trim__tabs" id="researchColorExteriorTrimTabs" role="tablist">
						<li role="presentation">
							<button class="tab-link active" id="exterior-sport-tab" data-target="#exterior-sport" type="button" role="tab" aria-controls="exterior-sport" aria-selected="true">Sport</button>
						</li>
						<li role="presentation">
							<button class="tab-link" id="exterior-club-tab" data-target="#exterior-club" type="button" role="tab" aria-controls="exterior-club" aria-selected="false">Club</button>
						</li>
						<li role="presentation">
					...
					<div class="research__color__exterior__trim__tabs-content" id="researchColorExteriorTrimTabsContent">
						...
						<!-- Exterior Sport Trim -->
						<div class="tab-panel show" id="exterior-sport" role="tabpanel" aria-labelledby="exterior-sport-tab">
							<?php

							$exterior_sport_colors = array(
								array(
							...
							<div class="research__color__section">
								<div class="research__color__photos">
									<?php foreach ( $exterior_sport_colors as $color ) : ?>
										<div class="research__color__photo" data-color="<?php echo esc_attr( $color['slug'] ); ?>">
											<picture>
												<source type="image/avif"
													srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-sport-' . $color['slug'] . '.avif' ); ?>">
												<source type="image/webp"
													srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-sport-' . $color['slug'] . '.png.webp' ); ?>">
												<img loading="lazy"
													decoding="async"
													src="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-sport-' . $color['slug'] . '.png' ); ?>"
													width="1222"
													height="703"
													alt="2022 MX-5 Miata Sport <?php echo esc_attr( $color['name'] ); ?>">
											</picture>
										</div>
									<?php endforeach; ?>
								</div>
								<div class="research__color__picker">
									<?php foreach ( $exterior_sport_colors as $color ) : ?>
										<button class="research__color__picker__button"
											...
											data-target-color="<?php echo esc_attr( $color['slug'] ); ?>" <?php echo ( '#f5f5f5' === $color['hex'] ? 'data-color="light"' : '' ); ?>><span class="visually-hidden">Sport <?php echo esc_html( $color['name'] ); ?></span><span class="research__color__picker__button__color" style="background-color: <?php echo esc_attr( $color['hex'] ); ?>;"></span></button>
									<?php endforeach; ?>
								</div>
						...
						<!-- Exterior Club Trim -->
						<div class="tab-panel" id="exterior-club" role="tabpanel" aria-labelledby="exterior-club-tab">
							<?php
							...
							$exterior_club_colors = array(
								...
								array(
									'name' => 'Machine Gray Metallic | Extra $495',
									'slug' => 'machine-gray',
									'hex'  => '#4f535b',
								),
							);
								...
								<div class="research__color__photos">
									<?php foreach ( $exterior_club_colors as $color ) : ?>
										<div class="research__color__photo" data-color="<?php echo esc_attr( $color['slug'] ); ?>">
											<picture>
												<source type="image/avif"
													srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-club-' . $color['slug'] . '.avif' ); ?>">
												<source type="image/webp"
													srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-club-' . $color['slug'] . '.png.webp' ); ?>">
												<img loading="lazy"
													decoding="async"
													src="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-club-' . $color['slug'] . '.png' ); ?>"
													width="1222"
													height="703"
								...
								<div class="research__color__photos">
									<?php foreach ( $exterior_grand_touring_colors as $color ) : ?>
										<div class="research__color__photo" data-color="<?php echo esc_attr( $color['slug'] ); ?>">
											<picture>
												<source type="image/avif"
													srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-gt-' . $color['slug'] . '.avif' ); ?>">
												<source type="image/webp"
													srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-gt-' . $color['slug'] . '.png.webp' ); ?>">
												<img loading="lazy"
													decoding="async"
													src="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-gt-' . $color['slug'] . '.png' ); ?>"
													width="1222"
													height="703"
				...
				<div class="tab-panel" id="roof" role="tabpanel" aria-labelledby="roof-tab">

					<!-- Roof trim tabs -->
					<ul class="research__color__roof__trim__tabs" id="researchColorRoofTrimTabs" role="tablist">
						<li role="presentation">
							<button class="tab-link active" id="roof-sport-tab" data-target="#roof-sport" type="button" role="tab" aria-controls="roof-sport" aria-selected="true">Sport</button>
						</li>
						<li role="presentation">
							<button class="tab-link" id="roof-club-tab" data-target="#roof-club" type="button" role="tab" aria-controls="roof-club" aria-selected="false">Club</button>
						</li>
						<li role="presentation">
							<button class="tab-link" id="roof-grand-touring-tab" data-target="#roof-grand-touring" type="button" role="tab" aria-controls="roof-grand-touring" aria-selected="false">Grand Touring</button>
						</li>
					</ul>

					<!-- Roof trim content -->
					<div class="research__color__roof__trim__tabs-content" id="researchColorRoofTrimTabsContent">

						<!-- Roof Sport Trim -->
						<div class="tab-panel show" id="roof-sport" role="tabpanel" aria-labelledby="roof-sport-tab">
							<?php

							$roof_sport_colors = array(
								array(
									'name' => 'Black',
									'slug' => 'black',
									'hex'  => '#101312',
							...
							<div class="research__color__section">
								<div class="research__color__photos">
									<?php foreach ( $roof_sport_colors as $color ) : ?>
										<div class="research__color__photo" data-color="<?php echo esc_attr( $color['slug'] ); ?>">
											<picture>
												<source type="image/avif"
													srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-sport-roof-' . $color['slug'] . '.avif' ); ?>">
												<source type="image/webp"
													srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-sport-roof-' . $color['slug'] . '.png.webp' ); ?>">
												<img loading="lazy"
													decoding="async"
													src="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-sport-roof-' . $color['slug'] . '.png' ); ?>"
													width="1222"
													height="703"
													alt="2022 MX-5 Miata Sport <?php echo esc_attr( $color['name'] ); ?>">
											</picture>
						...
						<!-- Roof Club Trim -->
						<div class="tab-panel" id="roof-club" role="tabpanel" aria-labelledby="roof-club-tab">
							<?php

							$roof_club_colors = array(
								array(
									'name' => 'Black',
									'slug' => 'black',
									'hex'  => '#101312',
							...
							<div class="research__color__section">
								<div class="research__color__photos">
									<?php foreach ( $roof_club_colors as $color ) : ?>
										<div class="research__color__photo" data-color="<?php echo esc_attr( $color['slug'] ); ?>">
											<picture>
												<source type="image/avif"
													srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-club-roof-' . $color['slug'] . '.avif' ); ?>">
												<source type="image/webp"
													srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-club-roof-' . $color['slug'] . '.png.webp' ); ?>">
												<img loading="lazy"
													decoding="async"
													src="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-club-roof-' . $color['slug'] . '.png' ); ?>"
													width="1222"
													height="703"
													alt="2022 MX-5 Miata Club <?php echo esc_attr( $color['name'] ); ?>">
											</picture>
						...
						<!-- Roof Grand Touring Trim -->
						<div class="tab-panel" id="roof-grand-touring" role="tabpanel" aria-labelledby="roof-grand-touring-tab">
							<?php

							$roof_grand_touring_colors = array(
								array(
									'name' => 'Black',
									'slug' => 'black',
									'hex'  => '#101312',
							...
							<div class="research__color__section">
								<div class="research__color__photos">
									<?php foreach ( $roof_grand_touring_colors as $color ) : ?>
										<div class="research__color__photo" data-color="<?php echo esc_attr( $color['slug'] ); ?>">
											<picture>
												<source type="image/avif"
													srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-gt-roof-' . $color['slug'] . '.avif' ); ?>">
												<source type="image/webp"
													srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-gt-roof-' . $color['slug'] . '.png.webp' ); ?>">
												<img loading="lazy"
													decoding="async"
													src="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-gt-roof-' . $color['slug'] . '.png' ); ?>"
													width="1222"
													height="703"
													alt="2022 MX-5 Miata Grand Touring <?php echo esc_attr( $color['name'] ); ?>">
											</picture>
				...
				<div class="tab-panel" id="interior" role="tabpanel" aria-labelledby="interior-tab">
					...
					<ul class="research__color__interior__trim__tabs" id="researchColorInteriorTrimTabs" role="tablist">
						<li role="presentation">
							<button class="tab-link active" id="interior-sport-tab" data-target="#interior-sport" type="button" role="tab" aria-controls="interior-sport" aria-selected="true">Sport</button>
						</li>
						<li role="presentation">
							<button class="tab-link" id="interior-club-tab" data-target="#interior-club" type="button" role="tab" aria-controls="interior-club" aria-selected="false">Club</button>
						</li>
						<li role="presentation">
					...
					<div class="research__color__interior__trim__tabs-content" id="researchColorInteriorTrimTabsContent">
						...
						<!-- Interior Sport Trim -->
						<div class="tab-panel show" id="interior-sport" role="tabpanel" aria-labelledby="interior-sport-tab">
							<?php

							$interior_sport_colors = array(
								array(
									'name' => 'Black Cloth',
									'slug' => 'black-cloth',
									'hex'  => '#101312',
							...
							<div class="research__color__section">
								<div class="research__color__photos">
									<?php foreach ( $interior_sport_colors as $color ) : ?>
										<div class="research__color__photo" data-color="<?php echo esc_attr( $color['slug'] ); ?>">
											<picture>
												<source type="image/avif"
													srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-sport-' . $color['slug'] . '.avif' ); ?>">
						...
						<!-- Interior Club Trim -->
						<div class="tab-panel" id="interior-club" role="tabpanel" aria-labelledby="interior-club-tab">
							<?php
			...
			<div class="tab-panel show" id="technology" role="tabpanel" aria-labelledby="technology-tab">
				<div class="research__highlights__carousel">
					...
					<div class="research__highlights__card">
						...
						<div class="research__highlights__card__body">With the MX-5 Commander control, you can intuitively navigate through playlists, driving directions, contacts and more without taking your eyes off the road.<sup>1</sup></div>
					</div>
					<div class="research__highlights__card">
						<div class="research__highlights__card__photo">
						<picture>
				...
				<div class="research__highlights__carousel">
					<div class="research__highlights__card">
						<div class="research__highlights__card__photo">
							<picture>
								<source type="image/avif"
									srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-safety-i-activsense.avif' ); ?>">
								<source type="image/webp"
									srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-safety-i-activsense.jpg.webp' ); ?>">
								<img loading="lazy"
									decoding="async"
									src="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-safety-i-activsense.jpg' ); ?>"
									width="969"
									height="457"
									alt="">
							</picture>
					...
					<div class="research__highlights__card">
						<div class="research__highlights__card__photo">
							<picture>
								<source type="image/avif"
									srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-safety-adaptive-lighting.avif' ); ?>">
								<source type="image/webp"
									srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-safety-adaptive-lighting.jpg.webp' ); ?>">
								<img loading="lazy"
									decoding="async"
									src="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-safety-adaptive-lighting.jpg' ); ?>"
									width="969"
									height="457"
									alt="">
							</picture>
					...
					<div class="research__highlights__card">
						...
						<picture>
								<source type="image/avif"
									srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-safety-traffic-sign.avif' ); ?>">
								<source type="image/webp"
									srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-safety-traffic-sign.jpg.webp' ); ?>">
								<img loading="lazy"
									decoding="async"
									src="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-safety-traffic-sign.jpg' ); ?>"
									width="969"
									height="457"
									alt="">
							</picture>
						...
						<div class="research__highlights__card__body">
							<p>To help you stay alert and informed, the available Traffic Sign Recognition System<sup>7</sup> can show you Speed Limit, Stop and Do Not Enter information in the MX-5 Miata&rsquo;s 4.6-inch full-color LCD display. The system&rsquo;s strategically mounted camera scans for road signs, so you can keep your focus on what&rsquo;s ahead.</p>
							<p class="disclaimer">For illustration purposes only<sup>6</sup></p>
						</div>
					</div>
					<div class="research__highlights__card">
						...
						<picture>
								<source type="image/avif"
									srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-safety-rear-cross-traffic.avif' ); ?>">
								<source type="image/webp"
									srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-safety-rear-cross-traffic.jpg.webp' ); ?>">
								<img loading="lazy"
									decoding="async"
									src="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-safety-rear-cross-traffic.jpg' ); ?>"
									width="969"
									height="457"
									alt="">
							</picture>
				...
				<div class="research__highlights__carousel">
					<div class="research__highlights__card">
						<div class="research__highlights__card__photo">
							<picture>
								<source type="image/avif"
									srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-design-elegance-details.avif' ); ?>">
								<source type="image/webp"
									srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-design-elegance-details.jpg.webp' ); ?>">
								<img loading="lazy"
									decoding="async"
									src="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-design-elegance-details.jpg' ); ?>"
									width="969"
									height="457"
									alt="">
							</picture>
						...
						<div class="research__highlights__card__title">Elegance is in the details</div>
						<div class="research__highlights__card__body">
							<p>Refined details are integral to the joy of driving. And you&rsquo;ll find them throughout the MX-5. New for 2021, available White Nappa leather seats bring a rejuvenating touch to Grand Touring interiors.</p>
						</div>
					</div>
					<div class="research__highlights__card">
						<div class="research__highlights__card__photo">
							<picture>
								<source type="image/avif"
									srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-design-timeless-style.avif' ); ?>">
								<source type="image/webp"
									srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-design-timeless-style.jpg.webp' ); ?>">
								<img loading="lazy"
									decoding="async"
									src="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-design-timeless-style.jpg' ); ?>"
									width="969"
									height="457"
									alt="">
							</picture>
						...
						<div class="research__highlights__card__section">Design</div>
						<div class="research__highlights__card__title">Timeless Style</div>
						<div class="research__highlights__card__body">
							<p>The MX-5 Miata convertible is inspired by classic roadsters of the 1960s. But that inspiration is expressed in a way that&rsquo;s pure car. With the sleek lines of our Kodo design, it communicates a sense of fluid motion, even at a standstill&mdash;and practically begs to be driven.</p>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="research__highlights__carousel">
					<div class="research__highlights__card">
						<div class="research__highlights__card__photo">
							<picture>
								<source type="image/avif"
									srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-performance-extension-of-you.avif' ); ?>">
								<source type="image/webp"
									srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-performance-extension-of-you.jpg.webp' ); ?>">
								<img loading="lazy"
									decoding="async"
									src="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-performance-extension-of-you.jpg' ); ?>"
									width="969"
									height="457"
									alt="">
							</picture>
						...
						<div class="research__highlights__card__title">An extension of you</div>
						<div class="research__highlights__card__body">
							<p>181 hp. 151 lb-ft of torque. A curb weight of under 2,400 pounds.<sup>1</sup> Behind the wheel of the MX-5 Miata, numbers transform into beautifully visceral, windswept joy. One of the many secrets to this exhilarating drive lies in its ideal power-to-weight ratio. You feel as though your MX-5 is connected to you, anticipating and answering your every command.</p>
						</div>
					</div>
					<div class="research__highlights__card">
						<div class="research__highlights__card__photo">
							<picture>
								<source type="image/avif"
									srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-performance-near-perfect-balance.avif' ); ?>">
								<source type="image/webp"
									srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-performance-near-perfect-balance.jpg.webp' ); ?>">
								<img loading="lazy"
									decoding="async"
									src="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-performance-near-perfect-balance.jpg' ); ?>"
									width="969"
									height="457"
									alt="">
							</picture>
						...
						<div class="research__highlights__card__section">PERFORMANCE</div>
						<div class="research__highlights__card__title">Near Perfect Balance</div>
						<div class="research__highlights__card__body">
							<p>Every car is engineered with the driver in mind. And nowhere is that clearer than in the MX-5 Miata. When working to achieve its near perfect 50/50 weight distribution, we made a point to take our measurements with a driver behind the wheel. The MX-5 Miata&rsquo;s storied handling doesn&rsquo;t start with a spec sheet. It starts with you.</p>
						</div>
					</div>
				</div>
				<div class="disclaimers">
					<p class="disclaimer"><sup>1</sup>Manual transmission models.</p>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="content-copy__container">
		<div class="content-copy content-copy--center">
			<div class="content-copy__subhead">History</div>
			<div class="content-copy__headline">Racing Heritage</div>
			<div class="content-copy__body">
				<p>By pushing our cars to the edge in unforgiving environments, we learn valuable lessons about safety, performance, efficiency and reliability. And that translates into a better car for you—both on the road and on the track. Perhaps this is the reason more cars are road-raced on any given weekend than any other car.<sup>11</sup></p>
				<picture>
					<source type="image/avif" srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-heritage.avif' ); ?>">
					<source type="image/webp" srcset="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-heritage.jpg.webp' ); ?>">
					<img loading="lazy"
						decoding="async" src="<?php echo esc_url( get_template_directory_uri() . '/images/research-2022-mx-5-miata-st-heritage.jpg' ); ?>"
						width="1704"
						height="905"
						alt="Black and white photo of car MX-5 Miata racecars on a track">
				</picture>
				<p class="disclaimer"><sup>11</sup>Based on Sports Car Club of America racing data.</p>
			</div>
		</div>
	</div>
	...
	<div class="form__container" id="form">
		<div class="form__wrap">
			<form class="form form--special-order"
				...
				<input type="hidden" name="vehicleModel" id="specialOrderVehicleModel" value="MX-5 Miata">
				...
				<input type="hidden" name="leadSourceId" id="specialOrderLeadSourceId" value="1748">
				<input type="hidden" name="leadName" id="specialOrderLeadName" value="custom Advertising - Special Order 2022 MX-5 Club Order">
