<?php
/**
 * The template for displaying the car Service Specials page.
 *
...
<div class="service">
		...
		<div class="service__hero__content">
			<div class="service__hero__copy">
				<div class="service__hero__headline">
					<h1 class="widow-fix">Specials On Service From <?php echo esc_html( $dealership_name ); ?></h1>
				</div>
				<p>Service specials available from <?php echo esc_html( $dealership_name ); ?> keep your vehicle performing at its best.</p>
			</div>
	...
	<div class="service__copy-center">
		<div class="service__copy-center__content">
			<p>The service team at <?php echo esc_html( $dealership_name ); ?> has been factory-trained to provide you with exceptional service and ensure your vehicle is performing at its best. View current specials on service from <?php echo esc_html( $dealership_name ); ?> below.</p>
		</div>
	</div>
